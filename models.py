    ...
    def evaluate_answer(challenge_id, submitted_answer):
        ...
        if ch_type == 'drag_drop':
            ...
            try:
                ...
                max_allowed = len(target_set) if target_set else 1
                is_correct = bool(sub_set and len(sub_set) <= max_allowed and (sub_set & target_set) and sub_set.issubset(target_set))
                points = 10.0 if is_correct else 0.0
